...
# ACDS 15.1 185 win32 2016.02.16.11:18:23
# ----------------------------------------
...
# # End of template
# ----------------------------------------
# If CV_PLL is one of several IP cores in your
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/CV_PLL.vho"
}
